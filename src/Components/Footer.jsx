...
const Footer = () => {
	return (
		<div>
			<footer className="footer sm:footer-horizontal bg-red-500 text-neutral-content p-10">
				<aside>
					<svg
						width="50"
						height="50"
				...
				<nav>
					<h6 className=" text-gray-900 text-xl font-bold">Social</h6>
					<div className="grid grid-flow-col gap-4">
						...
						<a href="https://www.facebook.com/mkallyan/">
							<FaFacebook className="text-gray-900 text-2xl" />
						</a>
					</div>
				</nav>
			</footer>
